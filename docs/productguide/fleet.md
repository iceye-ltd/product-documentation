...
Over the last year we have been filling out our constellation with our third generation satellites that have improved collection capabilities. When combined with our latest ground processing technology, the ICEYE fleet provides an optimium solution between image quality, rapid access and area coverage.


<figure>
<img src="../img/ICEYE_gen3_sat_space_1920px.jpg" style="width:100%">
<figcaption align = "center"><em>Figure 1: ICEYE Generation 3 Satellite</em></figcaption>
</figure>
...
| Range Bandwidth       | 37.6-600 MHz |
| Peak Radiated Power   | 3.2 kW |
| Polarization          | VV |
| Incidence angle range | 5-45° (mode dependent) |
| Mass                  | 110 kg |
| Communication [radar payload data downlink] | X-band 500 Mbits/s|
<figcaption align = "center"><em>Table 1: ICEYE Generation 3 satellite system parameters</em></figcaption>
</figure>
